{{-- <footer class="w-full my-28 md:my-5">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <a href="/" class="flex justify-center gap-2">
                <img src="{{ asset('images/logo_bem_2.png') }}" class="h-14" alt="">
                <h1 class="flex items-center text-2xl font-bold">BEM Universitas Trilogi</h1>
            </a>
            <ul
                ...
                <li>
                    <a href="javascript:;" class="text-gray-800 hover:text-gray-900">Beranda</a>
                </li>
                <li>
                    <a href="javascript:;" class=" text-gray-800 hover:text-gray-900">Tentang</a>
                </li>
                <li>
                    <a href="javascript:;" class=" text-gray-800 hover:text-gray-900">Berita</a>
                </li>
                <li>
                    <a href="javascript:;" class=" text-gray-800 hover:text-gray-900">Struktur</a>
                </li>
                <li>
                    <a href="javascript:;" class=" text-gray-800 hover:text-gray-900">Kontak</a>
                </li>
            </ul>
            ...
            <span class="text-lg text-gray-500 text-center block"><a href="https://pagedone.io/">bemtrilogi</a> 2025,
                All rights reserved.</span>
        </div>
    </div>
</footer> --}}

<footer class="bg-purple-gradient text-white py-8 w-full">
    <div class="container mx-auto flex flex-col items-center justify-center">
      <!-- Logo dan Nama -->
      <div class="flex items-center mb-4">
        <img src="{{ asset('images/images/logo_bem_2.png') }}" alt="Logo BEM" class="w-10 h-10 mr-2" />
        <span class="text-lg font-bold">BEM Universitas Trilogi</span>
      </div>
  
      <!-- Menu Navigasi -->
      {{-- <div class="flex space-x-6 mb-6 mt-3">
      ...
      <div class="flex space-x-6">
        <a href="#" class="text-2xl hover:text-gray-300"><box-icon name='tiktok' type='logo' ></box-icon></a>
        <a href="#" class="text-2xl hover:text-gray-300"><box-icon type='logo' name='youtube'></box-icon></a>
        <a href="#" class="text-2xl hover:text-gray-300"><box-icon type='logo' name='instagram'></box-icon></a>
      </div>
  
      <!-- Hak Cipta -->
      <p class="mt-6 text-sm">&copy; BEM Universitas Trilogi, All rights reserved.</p>
    </div>
  </footer>
